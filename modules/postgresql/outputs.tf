output "instance_name" {
  ...
  value       = module.postgresql_db.instance_name
}
...
output "read_replica_instance_names" {
  ...
  value       = module.postgresql_db.read_replica_instance_names
}

output "public_ip_address" {
  description = "The first public (PRIMARY) IPv4 address assigned for the master instance."
  value       = var.public ? module.postgresql_db.public_ip_address : ""
}

output "private_ip_address" {
  description = "The first private IPv4 address assigned for the master instance."
  value       = module.postgresql_db.private_ip_address
}

output "users" {
  description = "List of maps of users and passwords."
  value = [for r in module.postgresql_db.additional_users :
    {
      name     = r.name
      password = r.password
    }
